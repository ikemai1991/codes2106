setwd('D:/myprojects/20210616-substantial revision/epigenetic regulators-DEGs')
...
write.table(DEOutput,'20210618-EZH2-DEG.txt',sep = '\t')
...
#KEGG&GO
upgene = rownames(subset(DEOutput, P.Value < 0.1 & logFC > 1))
downgene = rownames(subset(DEOutput, P.Value < 0.1 & logFC<(-1)))
